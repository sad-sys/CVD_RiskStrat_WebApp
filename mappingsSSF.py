...
("category_Sex-specific factors_ts_Relative.age.of.first.facial.hair...Instance.0_2",
 "When did you start to grow facial hair?"),
("category_Sex-specific factors_ts_Relative.age.of.first.facial.hair...Instance.0_1",
 "When did you start to grow facial hair?"),
("category_Sex-specific factors_ts_Relative.age.of.first.facial.hair...Instance.0_3",
 "When did you start to grow facial hair?"),

("category_Sex-specific factors_ts_Relative.age.voice.broke...Instance.0_2",
 "When did your voice break?"),
("category_Sex-specific factors_ts_Relative.age.voice.broke...Instance.0_1",
 "When did your voice break?"),

("category_Sex-specific factors_ts_Hair.balding.pattern...Instance.0_1",
 "Which of the following best describes your hair/balding pattern?"),
("category_Sex-specific factors_ts_Hair.balding.pattern...Instance.0_2",
 "Which of the following best describes your hair/balding pattern?"),
("category_Sex-specific factors_ts_Hair.balding.pattern...Instance.0_3",
 "Which of the following best describes your hair/balding pattern?"),
("category_Sex-specific factors_ts_Hair.balding.pattern...Instance.0_4",
 "Which of the following best describes your hair/balding pattern?"),

("category_Sex-specific factors_ts_Number.of.children.fathered...Instance.0_Lower.third",
 "How many children have you fathered?"),
("category_Sex-specific factors_ts_Number.of.children.fathered...Instance.0_Middle.third",
 "How many children have you fathered?"),
("category_Sex-specific factors_ts_Number.of.children.fathered...Instance.0_Upper.third",
 "How many children have you fathered?"),

("category_Sex-specific factors_ts_Years.since.last.breast.cancer.screening...mammogram...Instance.0_Lower.third",
 "How many years ago was your last screen?"),
("category_Sex-specific factors_ts_Years.since.last.breast.cancer.screening...mammogram...Instance.0_Middle.third",
 "How many years ago was your last screen?"),
("category_Sex-specific factors_ts_Years.since.last.breast.cancer.screening...mammogram...Instance.0_Upper.third",
 "How many years ago was your last screen?"),

("category_Sex-specific factors_ts_Years.since.last.cervical.smear.test...Instance.0_Lower.third",
 "How many years ago was your last cervical smear test?"),
("category_Sex-specific factors_ts_Years.since.last.cervical.smear.test...Instance.0_Middle.third",
 "How many years ago was your last cervical smear test?"),

("category_Sex-specific factors_ts_Age.when.periods.started..menarche....Instance.0_Lower.third",
 "How old were you when your periods started?"),
("category_Sex-specific factors_ts_Age.when.periods.started..menarche....Instance.0_Middle.third",
 "How old were you when your periods started?"),
("category_Sex-specific factors_ts_Age.when.periods.started..menarche....Instance.0_Upper.third",
 "How old were you when your periods started?"),

("category_Sex-specific factors_ts_Age.at.menopause..last.menstrual.period....Instance.0_Middle.third",
 "How old were you when your periods stopped?"),
("category_Sex-specific factors_ts_Age.at.menopause..last.menstrual.period....Instance.0_Upper.third",
 "How old were you when your periods stopped?"),

("category_Sex-specific factors_ts_Time.since.last.menstrual.period...Instance.0_Lower.third",
 "How many days since your last menstrual period?"),
("category_Sex-specific factors_ts_Time.since.last.menstrual.period...Instance.0_Middle.third",
 "How many days since your last menstrual period?"),
("category_Sex-specific factors_ts_Time.since.last.menstrual.period...Instance.0_Upper.third",
 "How many days since your last menstrual period?"),

("category_Sex-specific factors_ts_Length.of.menstrual.cycle...Instance.0_Lower.third",
 "How many days is your usual menstrual cycle?"),
("category_Sex-specific factors_ts_Length.of.menstrual.cycle...Instance.0_Middle.third",
 "How many days is your usual menstrual cycle?"),

("category_Sex-specific factors_ts_Menstruating.today...Instance.0_0",
 "Are you menstruating today?"),

#("category_Sex-specific factors_ts_Number.of.live.births...Instance.0_Lower.third",
# "How many children have you had?"),
#("category_Sex-specific factors_ts_Number.of.live.births...Instance.0_Upper.third",
#"How many children have you had?"),

("category_Sex-specific factors_ts_Birth.weight.of.first.child...Instance.0_Lower.third",
 "What was the birth weight of your first child?"),
("category_Sex-specific factors_ts_Birth.weight.of.first.child...Instance.0_Middle.third",
 "What was the birth weight of your first child?"),
("category_Sex-specific factors_ts_Birth.weight.of.first.child...Instance.0_Upper.third",
 "What was the birth weight of your first child?"),

("category_Sex-specific factors_ts_Age.at.first.live.birth...Instance.0_Middle.third",
 "How old were you when you had your FIRST child?"),
("category_Sex-specific factors_ts_Age.at.first.live.birth...Instance.0_Upper.third",
 "How old were you when you had your FIRST child?"),

("category_Sex-specific factors_ts_Age.at.last.live.birth...Instance.0_Middle.third",
 "How old were you when you had your LAST child?"),
("category_Sex-specific factors_ts_Age.at.last.live.birth...Instance.0_Upper.third",
 "How old were you when you had your LAST child?"),

("category_Sex-specific factors_ts_Number.of.stillbirths...Instance.0_Middle.third",
 "How many stillbirths?"),
("category_Sex-specific factors_ts_Number.of.spontaneous.miscarriages...Instance.0_Middle.third",
 "How many spontaneous miscarriages?"),
("category_Sex-specific factors_ts_Number.of.spontaneous.miscarriages...Instance.0_Upper.third",
 "How many spontaneous miscarriages?"),
("category_Sex-specific factors_ts_Number.of.pregnancy.terminations...Instance.0_Middle.third",
 "How many terminations?"),
("category_Sex-specific factors_ts_Number.of.pregnancy.terminations...Instance.0_Upper.third",
 "How many terminations?"),

("category_Sex-specific factors_ts_Age.started.oral.contraceptive.pill...Instance.0_Lower.third",
 "About how old were you when you first went on the contraceptive pill?"),
("category_Sex-specific factors_ts_Age.started.oral.contraceptive.pill...Instance.0_Middle.third",
 "About how old were you when you first went on the contraceptive pill?"),
("category_Sex-specific factors_ts_Age.started.oral.contraceptive.pill...Instance.0_Upper.third",
 "About how old were you when you first went on the contraceptive pill?"),

("category_Sex-specific factors_ts_Age.when.last.used.oral.contraceptive.pill...Instance.0_Lower.third",
 "How old were you when you last used the contraceptive pill?"),
("category_Sex-specific factors_ts_Age.when.last.used.oral.contraceptive.pill...Instance.0_Middle.third",
 "How old were you when you last used the contraceptive pill?"),
("category_Sex-specific factors_ts_Age.when.last.used.oral.contraceptive.pill...Instance.0_Upper.third",
 "How old were you when you last used the contraceptive pill?"),

("category_Sex-specific factors_ts_Age.last.used.hormone.replacement.therapy..HRT....Instance.0_Middle.third",
 "How old were you when you last used HRT?"),
("category_Sex-specific factors_ts_Age.last.used.hormone.replacement.therapy..HRT....Instance.0_Upper.third",
 "How old were you when you last used HRT?"),

("category_Sex-specific factors_ts_Ever.had.hysterectomy..womb.removed....Instance.0_0",
 "Have you had a hysterectomy (womb removed)?"),
("category_Sex-specific factors_ts_Ever.had.hysterectomy..womb.removed....Instance.0_1",
 "Have you had a hysterectomy (womb removed)?"),

("category_Sex-specific factors_ts_Age.at.hysterectomy...Instance.0_Lower.third",
 "How old were you when you had your hysterectomy?"),
("category_Sex-specific factors_ts_Age.at.hysterectomy...Instance.0_Middle.third",
 "How old were you when you had your hysterectomy?"),
