...
def calculate_features(patient_id, submission_id):
    ...
    raw_features = calculate_model_features(
        ...
        template_path='model_files/feature_templates/model2_features.xlsx'
    )
    ...
    with open('model_files/imputers/health_and_medical_history_noDrop_rf.pkl', 'rb') as f:
    ...
    try:
        with open('model_files/scalers/health_and_medical_history_noDropscaler.pkl', 'rb') as f:
    ...
    out_path = f"model_outputs/patient_{patient_id}_model2_input_scaled.csv"
